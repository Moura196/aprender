...
- Here we created two profile users with specific passwords and roles. Only those users are going to be authenticated at our application.

## Authorization
- What I noticed is that for every kind of user, I should create a route for each one to have authorize to access.
